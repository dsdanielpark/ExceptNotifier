...
def get_version():
    filename = "ExceptionNotifier/__init__.py"
...
setup(
    ...
    url="https://github.com/dsdanielpark/ExceptionNotifier",
    ...
    entry_points={"console_scripts": ["ExceptionNotifier=ExceptionNotifier.cli:main"]},
)